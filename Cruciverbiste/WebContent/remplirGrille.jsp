...
<title>Remplissage grille</title>
...
<div id="barre">
	...
	<div id="content">
		<div id="outils">
			<form action="#">
				<table>
					...
					<tr>
						<td><input type="submit" value="Mettre à zero" /></td>
					</tr>
					<tr>
		...
		<img alt="images" src="images/grille.jpg" style="float: left;"/>
		<div id="rechercheMotif">
			<form action="#">
				<table>
					<tr>
					...
					<tr>
						<td colspan="2"><textarea id="resultatMots"></textarea></td>
					</tr>
				</table>
			</form>
		</div>
